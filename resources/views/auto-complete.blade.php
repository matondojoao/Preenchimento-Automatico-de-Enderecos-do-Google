...
<head>
    <title>Preenchimento Automatico de Enderecos do Google</title>
    <meta charset="utf-8">
            ...
            <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12 m-auto">
                <div class="card shadow">
                    <div class="card-header bg-primary">
                        <h5 class="card-title text-white">Preenchimento Automatico de Enderecos do Google</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="autocomplete"> Localização/Cidade/Endereço</label>
